const images = [
    ...
    { id: 'hanabi', src: './img/hanabi.png', name: '花火', value: 0, rarity: 'Common' },
    ...
    { id: 'suikakaba', src: './img/suikakaba.png', name: 'スイカカバ', value: 0, rarity: 'Common' },
    { id: 'girafa', src: './img/girafa.png', name: 'スイカキリン', value: 0, rarity: 'Common' },
    ...
    { id: 'sabotensame', src: './img/sabotensame.png', name: 'サメサボテン', value: 80, rarity: 'BrainrotGot' },
    ...
    { id: 'iruka', src: './img/iruka.png', name: 'イルカ', value: 185, rarity: 'BrainrotGot' },
    ...
    { id: 'bundin', src: './img/bundin.png', name: '筋肉うさぎ（イースターロット）', value: 3400, rarity: 'Secret-' },
    { id: 'pirulitoita', src: './img/pirulitoita.png', name: 'ペロペロキャンディー', value: 3500, rarity: 'Secret' },//飴
    { id: '2dantukue', src: './img/2dantukue.png', name: '2段つくえ', value: 3700, rarity: 'Secret' },
    { id: 'iisacro', src: './img/iisacro.png', name: 'ヤギ', value: 4000, rarity: 'Secret' },
    ...
    { id: 'clover', src: './img/clover.jpg', name: 'クローバー', value: 5700, rarity: 'Secret' },
    { id: 'legolem', src: './img/legolem.png', name: '合成のロボ', value: 6000, rarity: 'Secret' },
    { id: 'inu', src: './img/inu.png', name: 'カウボーイ犬', value: 6200, rarity: 'Secret' },
    { id: 'cornball', src: './img/cornball.png', name: 'コーンボール', value: 6500, rarity: 'Secret' },
    { id: 'wanihikouki', src: './img/wanihikouki.JPG', name: 'わに飛行機（合成限定）', value: 6600, rarity: 'Secret' },
    { id: '67', src: './img/67.png', name: '67', value: 6700, rarity: 'Secret' },
    { id: 'loshouse', src: './img/loshouse.png', name: 'ロス家', value: 7000, rarity: 'Secret' },
    { id: 'nomyegg', src: './img/nomyegg.png', name: 'ノーマイエッグ（イースターロット）', value: 7200, rarity: 'Secret-' },
    { id: 'budouonna', src: './img/budouonna.png', name: 'アセロラ', value: 7300, rarity: 'Secret' },
    ...
    { id: 'kirikabu', src: './img/kirikabu.png', name: '切り株', value: 8300, rarity: 'Secret' },
    { id: 'cacasito', src: './img/cacasito.png', name: '人工衛星ハムスター(合成限定)', value: 8500, rarity: 'Secret' },
    { id: 'sukebokyuuri', src: './img/sukebokyuuri.png', name: 'スケボーキュウリ', value: 8700, rarity: 'Secret' },
    { id: 'wanichari', src: './img/wanichari.JPG', name: 'ワニチャリ(合成限定)', value: 9000, rarity: 'Secret' },
    { id: 'lachristmas', src: './img/lachristmas.png', name: 'クリスマスラグランデ(クリスマス合成限定)', value: 9000, rarity: 'Secret-' },//クリスマスラグランデ
    { id: 'chikinbanana', src: './img/chikinbanana.png', name: 'にわとりバナナ', value: 9000, rarity: 'Secret' },
    { id: 'risukensi', src: './img/risu.JPG', name: 'リス剣士(ForestRot限定)', value: 9300, rarity: 'Secret-' },
    { id: 'penginking', src: './img/penginking.png', name: 'ペンギンキング', value: 9500, rarity: 'Secret' },
    { id: 'hue', src: './img/hue.JPG', name: 'ホイッスル(BallRot限定)', value: 9700, rarity: 'Secret-' },
    { id: 'pad', src: './img/pad.png', name: 'ケパット', value: 10000, rarity: 'Secret' },
    { id: 'kabuto', src: './img/kabuto.png', name: 'カブト鯉のぼり', value: 10000, rarity: 'Secret' },
    ...
    { id: 'ninzin', src: './img/ninzin.png', name: 'ニンジン（イースターロット）', value: 11700, rarity: 'Secret-' },
    ...
    { id: 'honeisu', src: './img/honeisu.png', name: '骨椅子', value: 13500, rarity: 'Secret' },
    { id: 'cookipad', src: './img/cookipad.png', name: 'クッキーパット', value: 14000, rarity: 'Secret-' },
    { id: 'mekainu', src: './img/mekainu.png', name: 'メカ犬', value: 14000, rarity: 'Secret' },
    { id: 'kobura', src: './img/kobura.png', name: 'コブラ', value: 14200, rarity: 'Secret' },

    { id: 'kabaking', src: './img/kabaking.png', name: 'カバキング', value: 14500, rarity: 'Secret' },
    { id: 'cloverchari', src: './img/cloverchari.jpg', name: 'クローバーチャリ', value: 14500, rarity: 'Secret' },
    { id: 'losgarama', src: './img/losgarama.png', name: 'ロスガラマ', value: 15000, rarity: 'Secret' },
    { id: 'wolfdensirenzi', src: './img/wolfdensirenzi.png', name: '電子レンジオオカミ', value: 15500, rarity: 'Secret' },
    { id: 'uchuhikoushi', src: './img/uchuhikoushi.png', name: '宇宙飛行士', value: 16000, rarity: 'Secret' },
    { id: 'soccerlaion', src: './img/soccerlaion.JPG', name: 'ライオンサッカー(BallRot限定)', value: 16000, rarity: 'Secret-' },
    { id: 'tutakinoko', src: './img/tutakinoko.JPG', name: 'ツタきのこ(ForestRot限定)', value: 16500, rarity: 'Secret-' },
    { id: 'kaerutoire', src: './img/kaerutoire.png', name: 'カエルトイレ', value: 17000, rarity: 'Secret' },
    { id: 'tranp', src: './img/tranp.png', name: 'トランプキング', value: 17500, rarity: 'Secret' },
    ...
    { id: 'koma', src: './img/koma.png', name: 'コマ', value: 19500, rarity: 'Secret' },
    ...
    { id: 'itigoaisu', src: './img/itigoaisu.JPG', name: 'いちごアイス', value: 27000, rarity: 'Secret' },
    { id: 'tiriabogado', src: './img/tiriabogado.png', name: 'チリ&アボガド', value: 28000, rarity: 'Secret' },
    { id: 'kamentako', src: './img/kamentako.png', name: '仮面たこ', value: 29000, rarity: 'Secret' },
    ...
    { id: 'yousei', src: './img/yousei.JPG', name: 'ようせい(ForestRot限定)', value: 34000, rarity: 'Secret-' },
    { id: 'tempelio', src: './img/tempelio.png', name: 'テンペリオ', value: 34500, rarity: 'Secret' },
    { id: 'shtekerito', src: './img/shtekerito.png', name: '電球', value: 35000, rarity: 'Secret' },
    { id: 'eggie', src: './img/eggie.png', name: 'エッグ家（イースターロット）', value: 35000, rarity: 'Secret-' },
    { id: 'wanitrack', src: './img/wanitrack.JPG', name: 'ワニトラック（合成限定）', value: 36000, rarity: 'Secret' },
    { id: 'mekauma', src: './img/mekauma.png', name: 'メカ馬', value: 37000, rarity: 'Secret' },
    { id: 'goal', src: './img/goal.JPG', name: 'ゴール(BallRot限定)', value: 37500, rarity: 'Secret-' },
    { id: 'capanna', src: './img/capanna.png', name: 'カッパーナ', value: 38000, rarity: 'Secret' },
    { id: 'kujaku', src: './img/kujaku.png', name: 'クジャク', value: 39000, rarity: 'Secret' },
    { id: 'spageti', src: './img/spageti.png', name: 'スパゲティトイレ', value: 40000, rarity: 'Secret' },
    { id: 'lostinpan', src: './img/lostinpan.JPG', name: 'ロスチンパンジー二(合成限定)', value: 41000, rarity: 'Secret' },
    { id: 'santani', src: './img/santani.png', name: 'サンタツリー(クリスマス合成限定)', value: 42000, rarity: 'Secret-' },//サンタニ
    { id: 'hebihune', src: './img/hebihune.png', name: 'へび船', value: 44000, rarity: 'Secret' },
    ...
    { id: 'tutasika', src: './img/tutasika.JPG', name: '鹿(ForestRot限定)', value: 55000, rarity: 'Secret-' },
    ...
    { id: 'kanransya', src: './img/kanransya.png', name: '背中観覧車', value: 80000, rarity: 'Eternal' },
    { id: 'messi', src: './img/messi.JPG', name: 'メッシ(BallRot限定)', value: 81000, rarity: 'Eternal-' },
    { id: 'lonaudo', src: './img/lonaudo.JPG', name: 'クリロナ(BallRot限定)', value: 81000, rarity: 'Eternal-' },
    ...
    { id: 'kusariuma', src: './img/kusariuma.png', name: 'クサリうま', value: 130000, rarity: 'Eternal' },
